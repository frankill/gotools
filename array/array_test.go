...
func TestArrayRandomSample(t *testing.T) {
	...
	input3 := []float64{}
	expected3 := []float64{}
	result3 := ArrayRandomSample(input3, 1, false)
	...
	result4 := ArrayRandomSample(input4, 5, false)
...
func TestArrayCumFun(t *testing.T) {
	input1 := []int{1, 2, 3, 4, 5, 6}
	output1 := ArrayCumFun(func(a, b int) int {
		return a + b
	}, input1)
	...
	output2 := ArrayCumFun(func(a, b float32) float32 {
		return a + b
	}, input2)
...
func TestArrayFindLast(t *testing.T) {
	...
	arr1 := [][]int{}
	result1 := ArrayFindLast(func(x ...int) bool { return false }, arr1...)
	expected1 := -1
	...
	result2 := ArrayFindLast(f, []int{1, 2, 3, 4, 5})
	expected2 := 3
...
func TestArrayFindFirst(t *testing.T) {
	// Test case 1: Empty array
	arr1 := [][]int{}
	result1 := ArrayFindFirst(func(x ...int) bool { return false }, arr1...)
	expected1 := -1
	if result1 != expected1 {
		t.Errorf("Test case 1 failed. Expected %d, got %d", expected1, result1)
	}
...
func TestArrayLast(t *testing.T) {
	// Test case 1: Empty array
	arr1 := [][]int{}
	result1 := ArrayLast(func(x ...int) bool { return false }, arr1...)
	expected1 := 0
...
func TestArrayFirst(t *testing.T) {
	// Test case 1: Empty array
	arr1 := [][]int{}
	result1 := ArrayFirst(func(x ...int) bool { return false }, arr1...)
	expected1 := 0
	if !reflect.DeepEqual(result1, expected1) {
		t.Errorf("Test case 1 failed. Expected %v, got %v", expected1, result1)
	}
...
func TestArrayAll(t *testing.T) {
	// Test case 1: Empty array
	arr1 := [][]int{}
	result1 := ArrayAll(func(x ...int) bool { return false }, arr1...)
	expected1 := false
	if result1 != expected1 {
	...
	arr2 := [][]int{{1, 2, 3, 4, 5}}
	result2 := ArrayAll(func(x ...int) bool {
		return x[0]%2 == 0
	}, arr2...)
	expected2 := false
	if result2 != expected2 {
	...
	arr3 := [][]int{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}}
	result3 := ArrayAll(func(x ...int) bool {
...
func TestArrayAny(t *testing.T) {
	...
	// Test case 2: Single array with all elements greater than 0
	arr2 := [][]int{{1, 2, 3, 4, 5}}
	result2 := ArrayAny(func(x ...int) bool {
		return x[0]%2 == 0
	}, arr2...)
	expected2 := true
	if result2 != expected2 {
...
func TestArrayReverseSplit(t *testing.T) {
	// Test case 1: Empty array
	arr1 := [][]int{{1}}
	result1 := ArrayReverseSplit(func(x ...int) bool { return true }, arr1...)
	expected1 := [][]int{{1}}
	if !reflect.DeepEqual(result1, expected1) {
		t.Errorf("Test case 1 failed. Expected %v, got %v", expected1, result1)
	}
	...
	result2 := ArrayReverseSplit(f, arr2...)
	expected2 := [][]int{}
	if !reflect.DeepEqual(result2, expected2) {
		t.Errorf("Test case 2 failed. Expected %v, got %v", expected2, result2)
	}
	...
	result4 := ArrayReverseSplit(f, arr4...)
	expected4 := [][]int{{1, 2}, {3}}
	if !reflect.DeepEqual(result4, expected4) {
...
func TestArraySplit(t *testing.T) {
	...
	arr := [][]int{}
	expected := [][]int{}
	result := ArraySplit(func(x ...int) bool { return true }, arr...)
	...
	expected = [][]int{{1}, {2, 3}}
	result = ArraySplit(func(x ...int) bool { return x[0]%2 == 0 }, arr...)
	if !reflect.DeepEqual(result, expected) {
	...
	expected = [][]int{{1}, {2, 3}}
	result = ArraySplit(func(x ...int) bool { return x[0] == x[1] }, arr...)
	if !reflect.DeepEqual(result, expected) {
...
func TestArrayReverseFill(t *testing.T) {
	...
	arr := [][]int{}
	expected := []int{}
	result := ArrayReverseFill(func(x ...int) bool { return false }, arr...)
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("Test case 1 failed. Expected: %v, Got: %v", expected, result)
	}
	...
	arr = [][]int{{1, 2, 3}, {4, 2, 6}, {7, 8, 9}}
	expected = []int{1, 3, 3}
	result = ArrayReverseFill(func(x ...int) bool { return x[0] != x[1] }, arr...)
	if !reflect.DeepEqual(result, expected) {
		t.Errorf("Test case 3 failed. Expected: %v, Got: %v", expected, result)
	}
...
func TestArrayFill(t *testing.T) {
	// 边界条件：空切片
	emptyResult := ArrayFill(alwaysTrue, []int{})
	if len(emptyResult) != 0 {
		t.Errorf("Expected empty slice for empty input, got %v", emptyResult)
	}

	// 单元素切片
	singleElementResult := ArrayFill(alwaysTrue, []int{1})
	...
	multiDimensionalResult := ArrayFill(alwaysTrue, multiDimensionalInput...)
	...
	multiDimensionalInput = [][]int{{1, 2, 3}, {4, 5, 6}}
	multiDimensionalResult = ArrayFill(func(x ...int) bool { return x[0] == 3 }, multiDimensionalInput...)
	...
	logicTestResult := ArrayFill(alwaysFalse, logicTestInput...)
...
func TestArrayFilterBoundary(t *testing.T) {
	...
	if result := ArrayFilter(emptyArrayFilter, emptyInput...); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	if result := ArrayFilter(singleElementFilter, singleElementInput...); !reflect.DeepEqual(result, expectedSingleElementResult) {
	...
	if result := ArrayFilter(allFalseFilter, allFalseInput...); !reflect.DeepEqual(result, expectedAllFalseResult) {
...
func TestArrayMap(t *testing.T) {
	...
	if result := ArrayMap(regularMap, regularInput...); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	emptyInput := [][]int{}
	expectedEmptyResult := []int{}
	if result := ArrayMap(emptyArrayMap, emptyInput...); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	singleElementInput := [][]int{{42}}
	expectedSingleElementResult := []int{42}
	if result := ArrayMap(singleElementMap, singleElementInput...); !reflect.DeepEqual(result, expectedSingleElementResult) {
	...
	if result := ArrayMap(unevenLengthsMap, unevenLengthsInput...); !reflect.DeepEqual(result, expectedUnevenLengthsResult) {
...
func TestArrayZip(t *testing.T) {
	...
	if result := ArrayZip(regularInput...); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	emptyInput := [][]int{}
	expectedEmptyResult := [][]int{}
	if result := ArrayZip(emptyInput...); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	singleElementInput := [][]int{{42}}
	expectedSingleElementResult := [][]int{{42}}
	if result := ArrayZip(singleElementInput...); !reflect.DeepEqual(result, expectedSingleElementResult) {
	...
	if result := ArrayZip(ArrayZip(unevenLengthsInput...)...); !reflect.DeepEqual(result, unevenLengthsInput) {
...
func TestArrayCompact(t *testing.T) {
	...
	if result := ArrayCompact(regularInput); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	emptyInput := []int{}
	expectedEmptyResult := []int{}
	if result := ArrayCompact(emptyInput); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	if result := ArrayCompact(identicalElementsInput); !reflect.DeepEqual(result, expectedIdenticalElementsResult) {
	...
	singleElementInput := []int{42}
	expectedSingleElementResult := []int{42}
	if result := ArrayCompact(singleElementInput); !reflect.DeepEqual(result, expectedSingleElementResult) {
...
func TestArrayReverse(t *testing.T) {
	...
	if result := ArrayReverse(regularInput); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	emptyInput := []int{}
	expectedEmptyResult := []int{}
	if result := ArrayReverse(emptyInput); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	singleElementInput := []int{42}
	expectedSingleElementResult := []int{42}
	if result := ArrayReverse(singleElementInput); !reflect.DeepEqual(result, expectedSingleElementResult) {
	...
	if result := ArrayReverse(twoElementsInput); !reflect.DeepEqual(result, expectedTwoElementsResult) {
...
func TestArrayFold(t *testing.T) {
	...
	if result := ArrayFold(sumFun, accFun, regularInput...); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	emptyInput := [][]int{}
	expectedEmptyResult := []int{}
	if result := ArrayFold(sumFun, accFun, emptyInput...); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	singleElementInput := [][]int{{42}}
	expectedSingleElementResult := []int{42}
	if result := ArrayFold(sumFun, accFun, singleElementInput...); !reflect.DeepEqual(result, expectedSingleElementResult) {
...
func TestArrayReduce(t *testing.T) {
	...
	if result := ArrayReduce(addFun, 0, regularInput); result != expectedRegularResult {
	...
	if result := ArrayReduce(addFun, 0, emptyInput); result != expectedEmptyResult {
	...
	if result := ArrayReduce(addFun, 0, singleElementInput); result != expectedSingleElementResult {
	...
	if result := ArrayReduce(concatenateFun, "", stringInput); result != expectedStringResult {
	...
	a := []int{1, 2, 3, 4}
	if r := ArrayReduce(fun, []int{}, a); !equalSlices(r, a) {
...
func TestArrayIntersect(t *testing.T) {
	...
	if result := ArrayIntersect(slice1, slice2, slice3); !reflect.DeepEqual(result, expectedRegularResult) {
	...
	if result := ArrayIntersect(emptySlices...); !reflect.DeepEqual(result, expectedEmptyResult) {
	...
	if result := ArrayIntersect(singleSlice); !reflect.DeepEqual(result, expectedSingleSliceResult) {
	...
	if result := ArrayIntersect(differentSlices...); !reflect.DeepEqual(result, expectedDifferentSlicesResult) {
	...
	if result := ArrayIntersect(duplicateSlices...); !reflect.DeepEqual(result, expectedDuplicateSlicesResult) {
...
func TestArrayEnumerateDense(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ArrayEnumerateDense(tt.arr); !reflect.DeepEqual(got, tt.expected) {
...
func TestArraySort(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result := ArraySort(sortFunc, tt.arr); !reflect.DeepEqual(result, tt.expected) {
...
func TestArrayCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ArrayCount(tt.fun, tt.arrs...)
...
func TestArrayHasAll(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ArrayHasAll(tt.arr, tt.elems...)
			if result != tt.expected {
...
func TestArrayHasAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ArrayHasAny(tt.arr, tt.elems...)
			if result != tt.expected {
...
func TestArrayConcat(t *testing.T) {
	// 测试空切片输入
	emptyResult := ArrayConcat[[]int, int]()
	if len(emptyResult) != 0 {
		t.Errorf("Expected empty slice for empty input, got %v", emptyResult)
	}
	...
	singleResult := ArrayConcat(singleSlice)
	...
	multipleResult := ArrayConcat(multipleSlices...)
	...
	stringResult := ArrayConcat(stringSlices...)
...
func TestArrayHasSequence(t *testing.T) {
	...
	expected := true
	expectedIndex := 4
	result, index := ArrayHasSequence(arr1, arr2)
...
func TestArraySequenceCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// 调用待测试的函数
			count := ArraySequenceCount(tt.arr1, tt.arr2)
...
func TestArrayExtractByIndex(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			actual := ArrayChoose(test.index, test.arr)
