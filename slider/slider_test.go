...
func TestSum(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(sum, expectedSum)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
...
func TestMax(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(max, expectedMax)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
...
func TestMin(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(min, expectedMin)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
...
func TestMean(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(mean, expectedMean)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
...
func TestPaste(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(paste, expectedPaste)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
...
func TestSlideIndex(t *testing.T) {
	...
	if array.All(gotools.Identity[bool], op.Eq(slideIndex, expectedSlideIndex)) {
		t.Log("测试通过")
	} else {
		t.Error("测试失败")
	}
